...
(function($) {
    var allCities = ['小黄侗寨|xiaohuang|xh', '占里侗寨|zhanli|zl', '加榜梯田|jiabangtitian|jbtt', '肇兴侗寨|zhaoxin|zx', '朗德上寨|langde|ld', '西江苗寨|xijiang|xj', '地扪|dimen|dm',
    '南花苗寨|nanhua|nh','季刀苗寨|jidao|jd'
    ];
    ...
    KuCity.prototype = {
        ...
        creatItem: function() {
            ...
            var template = '<div class="kucity"><div class="citybox"><h3 class="kucity_header">(温馨贴士：您可以输入省份/城市/景点,暂不支持村落搜索)</h3><ul class="kucity_nav"><li class="active">黄金村落</li><li>ABCDEFGH</li><li>IJKLMNOP</li><li>QRSTUVWXYZ</li></ul><div class="kucity_body"></div></div><ul class="result"></ul></div>';
